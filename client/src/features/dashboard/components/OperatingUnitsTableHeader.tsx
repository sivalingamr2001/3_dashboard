  ...
  return (
    <TableHeader className="select-none border-none">
      ...
      <TableRow className="border-none bg-[#1e293b] hover:bg-[#1e293b]">
        ...
        <TableHead rowSpan={3} className="min-w-[320px] text-left text-xl font-bold text-white px-4 align-middle border-r border-slate-700/30">
          Operating Unit
        </TableHead>
        
        <TableHead colSpan={4} className="text-center text-xl font-semibold text-white py-1.5 border-r border-slate-700/30">
          Turnover (₹ Cr)
        </TableHead>
        ...
        <TableHead colSpan={2} className="text-center text-xl font-semibold text-white py-1.5 border-r border-slate-700/30">
          Pending Orders (₹ Cr)
        </TableHead>

        {/* Forces Inventory down through all three header rows */}
        <TableHead rowSpan={3} className="min-w-[120px] text-center text-xl font-semibold text-white px-4 align-middle bg-[#1e293b]">
      ...
      <TableRow className="border-none bg-[#1e293b] hover:bg-[#1e293b]">
        ...
        <TableHead rowSpan={2} className="bg-[#10b981] text-center text-xl font-semibold text-white px-4 align-middle border-r border-emerald-600/30 min-w-[90px]">
      ...
      <TableRow className="border-none bg-[#3b82f6] text-[10px] font-medium text-white">
        {/* 4 Turnover columns */}
        <TableHead className="bg-[#3b82f6] text-center text-white py-1 border-r border-blue-400/20">As on Date *</TableHead>
        <TableHead className="bg-[#3b82f6] text-center text-white py-1 border-r border-blue-500">Current Month</TableHead>
        <TableHead className="bg-[#64748b] text-center text-white py-1 border-r border-slate-500/30">As on Date *</TableHead>
        <TableHead className="bg-[#64748b] text-center text-white py-1 border-r border-slate-50/10">Current Month</TableHead>

        {/* 2 Pending Orders columns */}
        <TableHead className="bg-[#3b82f6] text-center text-white py-1 border-r border-blue-400/20">As on Date *</TableHead>
        <TableHead className="bg-[#3b82f6] text-center text-white py-1">Current Month</TableHead>
      </TableRow>
